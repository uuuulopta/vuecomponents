<template>
    ...
    class="absolute max-w-sm break-words z-10 py-1 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 dark:bg-gray-700">
...
target.addEventListener('mouseout', () => {
    ...
    setTimeout(() => {tooltip.style="vibility:hidden;"},300)
    popper.update();
})
